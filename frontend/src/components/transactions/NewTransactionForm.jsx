...
function NewTransactionForm({ initial, onSubmit, onCancel, loading }) {
      ...
      <div className="grid grid-cols-2 gap-x-4">
        ...
        <div className="mb-3.5 flex flex-col gap-1">
          ...
          <textarea
            name="notes"
            onChange={set("notes")}
            className="font-inherit box-border w-full resize-none rounded border border-slate-300 bg-slate-50 px-2.5 py-2 text-sm transition-colors outline-none focus:border-[#1e3a5f] focus:bg-white"
            id=""
            maxLength={35}
          ></textarea>
        </div>
